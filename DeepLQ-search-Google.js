...
Quantumult X:
# dlc xxx (DeepL 译至中)
^https:\/\/google.com\/\?q=dlc(\+|%20)([^&]+).+ url script-echo-response https://raw.githubusercontent.com/zZPiglet/Task/master/asset/DeepLQ-search.js
# dle xxx (DeepL 译至英)
^https:\/\/google.com\/\?q=dle(\+|%20)([^&]+).+ url script-echo-response https://raw.githubusercontent.com/zZPiglet/Task/master/asset/DeepLQ-search.js
# dlj xxx (DeepL 译至日)
^https:\/\/google.com\/\?q=dlj(\+|%20)([^&]+).+ url script-echo-response https://raw.githubusercontent.com/zZPiglet/Task/master/asset/DeepLQ-search.js

Surge:
# dlc xxx (DeepL 译至中)
DeepLtoChinese = type=http-request,pattern=^https:\/\/google.com\/\?q=dlc(\+|%20)([^&]+).+,script-path=https://raw.githubusercontent.com/zZPiglet/Task/master/asset/DeepLQ-search.js
# dle xxx (DeepL 译至英)
DeepLtoEnglish = type=http-request,pattern=^https:\/\/google.com\/\?q=dle(\+|%20)([^&]+).+,script-path=https://raw.githubusercontent.com/zZPiglet/Task/master/asset/DeepLQ-search.js
# dlj xxx (DeepL 译至日)
DeepLtoJapanese = type=http-request,pattern=^https:\/\/google.com\/\?q=dlj(\+|%20)([^&]+).+,script-path=https://raw.githubusercontent.com/zZPiglet/Task/master/asset/DeepLQ-search.js
...
const deeplr = /^https:\/\/google.com\/\?q=dl(c|e|j)(\+|%20)([^&]+).+/;
